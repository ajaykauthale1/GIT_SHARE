...
public class PageRankInvoker {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total Sink Nodes:" + pageRank.getSinkNodes(pageMap).size());
		System.out.println("Total Source Nodes:" + pageRank.getSourceNodes(pageMap).size());
		...
		System.out.println("Total Nodes whose PR < Uniform PR: " + pageRank.getNodesWithFinalPRLessThanInitial(pageMap).size());
