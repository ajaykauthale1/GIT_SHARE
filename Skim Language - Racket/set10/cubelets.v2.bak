      ...
      (local
        ...
        (if (and (not (already-present? team block))
            ...
            (if (overlap? x y x-pos y-pos)
                (begin
                  (register-teammate block)
                  (register-all-team block-team)
                  (for-each
                   (lambda (b) (send b register-all-team
                                     (append block-team (list block))))
                   current-team)
                  
                  (send block register-teammate this)

                  (for-each
                   (lambda (b) (send b register-teammate this))
                   block-team)
                  
                  (send block register-all-team current-team)
