...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname screensaver-2) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define (world-after-tick ws)
  (cond
    ...
    [else (make-WorldState (world-rect1 ws) (world-rect2 ws) (WorldState-paused? ws) ZERO ZERO)]))
...
(define (world-after-key-event ws ke)
  (cond
    [(key=? ke " ")
     (make-WorldState (WorldState-rect1 ws) (WorldState-rect2 ws) (not (WorldState-paused? ws)) ZERO ZERO)]
...
(define (world-after-mouse-event ws mx my me)
  (cond
    ...
    [(mouse=? DRAG me) (world-after-button-down ws mx my me)]
    [else ws]))
