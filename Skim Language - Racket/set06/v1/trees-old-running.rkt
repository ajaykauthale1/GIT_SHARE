...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname trees-old-running) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define (display-all-trees trees scn)
  (cond
    ...
    [else (display-all-trees (rest trees)
                             (place-tree
                              (first trees)
                              (posn-x (node-posn (tree-root (first trees)))) scn))]))
